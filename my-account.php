<?php 
    ...
    if(strlen($_SESSION['login'])==0)
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            $query=mysqli_query($con,"update user set name='$name', contact_no='$contact' where id='".$_SESSION['id']."'");
            if($query)
            {
...
<html lang="en">
<head>
	<title>Uni Share | My accout</title>
...
<body id="top">	
    ...
    <div class="container">        
        <h1 style="text-align:center; margin-top:20px; color:#223A66;">Welcome To <span style="color:red;">Uni</span> Share Family!</h1>
    </div>
    <br>
    <div class="container">
                    ...
                    <div class="card card-outline-secondary">
                        ...
                        ?>
                            <form action="" method="post">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Current Points</label>
                                    <div class="col-lg-9">
                                    <input class="form-control" type="text" value="<?php echo $row['point']; ?>" name="balance" disabled>
                                    </div>
                                </div>                    
                                <div class="form-group row">
