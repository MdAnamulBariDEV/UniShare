	...
	<section class="shop">
		...
		<div class="col-md-12">
			<div class="container">
				<div class="row">
					<?php
						$ret=mysqli_query($con,"select * from files where title like '$find' ORDER BY counter Desc");
					...
					<div class='col-md-4' style='margin-bottom:30px;'>
						<div class='card' style='width: 18rem; text-align:center;'>
							...
							<div class='card-body'>
								...
								<p>
									<?php if($total > 0){ ?>
									Total Download: <?php echo $total; ?>
									<?php } ?>
								</p>
								
								<a href="details.php?id=<?php echo $pro_id;?>&name=<?php echo $vdo;?>"
